...
function FloatingTextFormat({
	...
	return (
		<div
			...
			className="absolute top-0 left-0 z-70 flex gap-1 rounded-md border bg-background p-1 opacity-0 shadow-md transition-opacity duration-300 will-change-transform"
		>
			{editor.isEditable() && (
				<>
					<ToggleGroup
